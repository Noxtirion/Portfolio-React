   ...
   <section className="about">
      ...
      <div className="about__description">
         <p>
            ...
            path. Now is the time when I would like to accelerate my development by working in a
            real environment, because no sources of learning can replace it. Despite of lack
            experience I would like to find a place where I can get the knowledge and push forward
