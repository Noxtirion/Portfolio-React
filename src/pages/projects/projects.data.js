const PROJECTS_DATA = [
   {
      ...
      liveUrl: "https://peaceful-nightingale-272ccf.netlify.app",
      githubUrl: "https://github.com/Noxtirion/Restaurant",
      technologyUsed: ["Angular", "RxJS", "Firebase", "SCSS"],
   },
   {
      id: 2,
      title: "Cloth Shop",
      description:
         "Project of Cloth Store from Udemy course. Instead of classes I have used functional components with hooks. I have created also contact component and made shop more responsive.",
      imageUrl: "shop.png",
